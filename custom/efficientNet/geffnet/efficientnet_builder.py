...
def resolve_act_layer(kwargs, default='swish'):
...
class DepthwiseSeparableConv(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, dw_kernel_size=3,
        ...
        if se_ratio is not None and se_ratio > 0.:
            ...
            # print("use identity instead of SE")
            self.se = nn.Identity()
...
class InvertedResidual(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, dw_kernel_size=3,
        ...
        # print('in_chs', in_chs, 'out_chs', out_chs, 'dw_kernel_size', dw_kernel_size,
        #      'stride', stride, 'pad_type', str(pad_type), 'act_layer', str(act_layer),
        #      'noskip', noskip, 'exp_ratio', exp_ratio, 'exp_kernel_size', exp_kernel_size,
        #      'pw_kernel_size', pw_kernel_size, 'se_ratio', se_ratio, 'se_kwargs', se_kwargs,
        #      'norm_layer', norm_layer, 'norm_kwargs', norm_kwargs, 'conv_kwargs', conv_kwargs, 'drop_connect_rate', drop_connect_rate)
        norm_kwargs = norm_kwargs or {}
        ...
        # print(isinstance(self.bn1, ABN), act_layer)
        # print(self.bn1)
...
class EfficientNetBuilder:
    ...
    def _make_block(self, ba):
        ...
        if bt == 'ir':
            ...
            ba['drop_connect_rate'] = self.drop_connect_rate * self.block_idx / self.block_count
            ba['se_kwargs'] = self.se_kwargs
            # Efficient LPs uses standard convs block = StandardConv(**ba)
