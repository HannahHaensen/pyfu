...
from custom.mmdet.core import auto_fp16
from custom.mmdet.ops import ConvModule
...
class TWOWAYFPN(nn.Module):
    """
    2-Way Feature Pyramid Network.

    This is an implementation of - 2-Way Feature Pyramid Networks for Object
    Detection (https://arxiv.org/abs/2004.02307)
    ...
    def __init__(self,
        ...
        self.lateral_convs_top = nn.ModuleList()
        self.lateral_convs_bottom = nn.ModuleList()
    ...
    def forward(self, inputs):
        ...
        # print(len(inputs))
        # for elem in inputs:
        #    print("---> inputs", elem.shape)
        assert len(inputs) == len(self.in_channels)
        # print("TWO WAY FPN")
        # build laterals
        # print("TOP ")
        # TOP FPN (purple in image)
        laterals_top = [
            lateral_conv(inputs[i + self.start_level])
            for i, lateral_conv in enumerate(self.lateral_convs_top)
        ]
        # BOTTOM FPN (blue in image)
        laterals_bottom = [
        ...
        for i in range(used_backbone_levels - 1, 0, -1):
            ...
            # upsample of top to last feature size --> prev_shape
        ...
        for i in range(used_backbone_levels - 1, 0, -1):
            ...
            # upsample of bottom to last feature size --> prev_shape
