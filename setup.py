...
version_file = 'custom/mmdet/version.py'
...
def get_hash():
    if os.path.exists('.git'):
        ...
        try:
            from custom.mmdet.version import __version__
...
if __name__ == '__main__':
    ...
    setup(
        ...
        package_data={'custom.mmdet.ops': ['*/*.so']},
        classifiers=[
...
#        },
        ext_modules=[
            make_cuda_ext(
                name='compiling_info',
                module='custom.mmdet.ops.utils',
                sources=['src/compiling_info.cpp']),
            make_cuda_ext(
                name='nms_cpu',
                module='custom.mmdet.ops.nms',
            ...
            make_cuda_ext(
                name='carafe_cuda',
                module='custom.mmdet.ops.carafe',
